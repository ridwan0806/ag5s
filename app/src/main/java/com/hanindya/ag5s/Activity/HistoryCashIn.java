...
public class HistoryCashIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView dateFrom = findViewById(R.id.txtHistoryCashInStartDate);
        TextView dateTo = findViewById(R.id.txtHistoryCashInEndDate);
        ...
        dbUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                tmpSummary = root.child("Summary").child(branchName).child(userId).child("CashIn");
    ...
    private void getTempDataHistoryCashIn() {
        ...
        adapter = new FirebaseRecyclerAdapter<HistoryRekapCashIn, VHHistoryCashIn>(list) {
            ...
            protected void onBindViewHolder(@NonNull VHHistoryCashIn holder, int position, @NonNull HistoryRekapCashIn model) {
                String dateOrder = adapter.getItem(position).getTanggal();
                ...
                holder.historyCashInNumber.setText(number+".");
                ...
                holder.historyCashInTotalBill.setText(formatRp.format(total));
                holder.menuHistoryCashIn.setOnClickListener(view -> {
                    Intent detailOrder = new Intent(HistoryCashIn.this, HistoryCashInOrders.class);
                    detailOrder.putExtra("orderDate",dateOrder);
