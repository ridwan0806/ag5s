...
import com.hanindya.ag5s.Activity.CashierOrderDetailCancel;
...
public class CashierCancel extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_cashier_cancel,container,false);
        recyclerView = layout.findViewById(R.id.rv_cashier_cancel);
        layoutManager = new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false);
        recyclerView.setLayoutManager(layoutManager);
        progressBar = layout.findViewById(R.id.pb_cashier_cancel);
    ...
    private void getOrderList() {
        FirebaseRecyclerOptions<Order> list =
                new FirebaseRecyclerOptions.Builder<Order>()
                        .setQuery(dbOrder.orderByChild("orderStatus").equalTo("Cancel"),Order.class)
                        .build();
            ...
            protected void onBindViewHolder(@NonNull VHCashierComplete holder, int position, @NonNull Order model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent detailOrderCancel = new Intent(getContext(), CashierOrderDetailCancel.class);
                        detailOrderCancel.putExtra("orderId",adapter.getRef(position).getKey());
                        startActivity(detailOrderCancel);
                    }
                });
            }
